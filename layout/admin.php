...
<head>
    ...
    <title>Admin Dashboard - Busy Canvas</title>
    <link rel="icon" href="../assets/img/logo/1.jpg" />
    ...
    <header class="admin-header">
        <nav class="navbar navbar-expand-lg">
            <div class="container-fluid">
                <a class="navbar-brand" href="../layout/index.html">
                    <img src="../assets/img/logo/1.jpg" alt="Logo" width="30" height="30"
                        class="d-inline-block align-text-top" />
                    <span class="brand-text">Busy Canvas Admin</span>
                </a>
                <div class="admin-nav">
                    <a href="../layout/index.html" class="back-btn">
    ...
    <section class="admin-section">
        <div class="container-fluid">
            ...
            <div class="dashboard-header">
                ...
                <p>Manage scheduled classes and orders</p>
            </div>
            ...
            <ul class="nav nav-tabs admin-tabs" id="adminTabs" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="classes-tab" data-bs-toggle="tab" data-bs-target="#classes"
                        ...
                        <i class="fas fa-chalkboard-teacher"></i> Scheduled Classes
                    </button>
                </li>
                <li class="nav-item" role="presentation">
                ...
                <div class="tab-pane fade show active" id="classes" role="tabpanel">
                    <div class="admin-card">
                        <div class="card-header-section">
                            <h2><i class="fas fa-chalkboard-teacher"></i> Scheduled Classes</h2>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                    ...
                    <form id="editClassForm">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Email</label>
                                    <input type="email" class="form-control" id="editClassEmail" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Phone</label>
                                    <input type="tel" class="form-control" id="editClassPhone" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Time</label>
                                    <input type="time" class="form-control" id="editClassTime" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="editClassSessionType" readonly>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Art Medium</label>
                                    <input type="text" class="form-control" id="editClassArtMedium" readonly>
                                </div>
                            </div>
                        </div>
                    </form>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" onclick="saveClassEdit()">Save Changes</button>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="editOrderArtworkType" readonly>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Canvas Size</label>
                                    <input type="text" class="form-control" id="editOrderCanvasSize" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label>Special Instructions</label>
                            <textarea class="form-control" id="editOrderInstructions" rows="3" readonly></textarea>
                        </div>
                    </form>
                </div>
                <div class="modal-footer">
